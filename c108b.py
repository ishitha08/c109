...
print('{}% of data for height lies within first standard deviation',format(len(height_list_of_data_within_1_std_deviation)*100.0/len(height_list)))
print('{}% of data for height lies within second standard deviation',format(len(height_list_of_data_within_2_std_deviation)*100.0/len(height_list)))
print('{}% of data for height lies within third standard deviation',format(len(height_list_of_data_within_3_std_deviation)*100.0/len(height_list)))

print('{}% of data for weight lies within first standard deviation',format(len(weight_list_of_data_within_1_std_deviation)*100.0/len(weight_list)))
print('{}% of data for weight lies within second standard deviation',format(len(weight_list_of_data_within_2_std_deviation)*100.0/len(weight_list)))
print('{}% of data for weight lies within third standard deviation',format(len(weight_list_of_data_within_3_std_deviation)*100.0/len(weight_list)))
